...
try{
	...
	String sql="select DISTINCT  S.NAME ,S.ID FROM COURSES S INNER JOIN ATTENDENCE A ON A.CID=S.ID JOIN USERS U ON U.ID=A.SID WHERE U.ID="+Uid;
...
<%while(rs.next()){
	...
	System.out.println(name);%>
      <div class="col-sm-7">
        <button type="submit" class="btn btn-default" style="width: 100px;" name="id" value="<%=id %>" disabled> <%=name %> </button>
        <br>
        <br>
      </div>
                               <%}	
