...
<nav class="navbar navbar-default">
  ...
  System.out.println("dfghjjhgfd"+session.getAttribute("Uid"));
  String name="";
  String id="";
...
try{
	...
	%>
 <form class="form-horizontal" action="RegisterCourse" method="post">
  <div class="container">
...
<%while(rs.next()){
	...
	%>
      <div class="col-sm-7">
      <label class="control-label col-sm-4" for="add"><%=name %></label>
        <button type="submit" class="btn btn-default" style="width: 100px;" name="id" value="<%=id %>"> <%=id %> </button>
        <br>
        <br>
      </div>
